...
namespace PaymentContext.Domain.Entities
{
    ...
    {
        //Livro
        //CleanCode = Rober C. Martin(Uncle Bob)
        //CleanCoder = Rober C. Martin(Uncle Bob)
        //Clean Architecture = Rober C. Martin(Uncle Bob)
        protected Payment(DateTime paidDate, DateTime expireDate, decimal total, decimal totalPaid, Address address, Document document, string payer, Email email)
        {
            ...
            AddNotifications(new Contract<Notification>()
                ...
                .IsLowerOrEqualsThan(Total, TotalPaid, "Payment.TotalPaid", "O Valor pago é menor que o do pagamento")
            );
        }
